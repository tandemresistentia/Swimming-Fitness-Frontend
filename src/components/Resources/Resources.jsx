    ...
    <div className='app-resources'>
      ...
      <div className='resources-main'>
        ...
        <p className='title-small'>
          Your Source for Swim Training Resources: Explore Our Page</p> 
        </div> 
        <div className='resources-body'>
          <div className='resources-body-element-1'>
            ...
            <p className='resources-body-text'>Beginner Swim Workout 1
                ...
                between each set
                Cool down: 200 easy any swim</p>
              <a className='resources-body-button' 
              href="https://www.sport-fitness-advisor.com/swim-workouts.html" 
              target="_blank" rel="noopener noreferrer">Continue</a>
          </div>
          ...
          <div className='resources-body-element-2'>
            ...
            <div className='resources-body-element-line'></div>
            <p className='resources-body-text'>600 choice strokes as 200 swim, 
                                  200 kick, 200 drill
      ...
      <div className='resources-footer'><Footer /></div>
    </div>
  )
}
